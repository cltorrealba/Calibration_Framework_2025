function dxdt = Zenteno_Model_2020_PEVth9_2023(t,x,k,int_time,exp_temp,kfixed)
...
% dCO2dt = klatf*(Csat-CO2);                          % CO2
%                                                     
% dTdt   = DHrx/(rho_must*cpm)*(dGdt+dFdt)-(Ufc*Afc)*(1/(rho_must*cpm*V_must))*(T-Tr);    % Temperature
