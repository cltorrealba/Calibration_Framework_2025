...
% PIL scale cross-validation calibration
% Updated to store nested CV results + data field, compatible with
% Procesador_AICc_Radj / Process_IC_Corrected_2023b_robust

clearvars -except All_Result
...
for n = 1:length(ids)
    ...
    save('5_perc_Models_Z_PIL.mat', 'All_Result')
end