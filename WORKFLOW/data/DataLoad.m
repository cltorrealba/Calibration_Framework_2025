...
warnVarNames = warning('query','MATLAB:table:ModifiedAndSavedVarnames');
warning('off','MATLAB:table:ModifiedAndSavedVarnames');
cleanupWarning = onCleanup(@() warning(warnVarNames.state,'MATLAB:table:ModifiedAndSavedVarnames')); %#ok<NASGU>
