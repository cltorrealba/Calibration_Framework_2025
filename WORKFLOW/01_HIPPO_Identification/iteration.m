...
close all
[AICc,BIC,CI,CC,Mc,~,diff] = reg_analysis(k_SSm);
...
%Delete unnecessary temporary files (only if present):
delete('Sensib*')
if exist('ssm_report.mat','file'), delete('ssm_report.mat'); end
if exist('Mc.txt','file'), delete('Mc.txt'); end
if exist('GraficoBarra.txt','file'), delete('GraficoBarra.txt'); end
