...
**PASS_CONDITIONAL**. Goal 0 scaffolding and portable provenance were generated; no source data were copied and no scientific model was calibrated.
...
- Read-only source checks: `PASS_CONDITIONAL`.
...
Goal 0 preflight runtime: 10.528 seconds.

## Limitations

- 4 eligible Pilot 2026 model-ready runs were found; none was selected.
- Declared historical source-check failures remain unresolved: pyomo-doe:campaign_audit_hashes.
...
G00 is `PASS_CONDITIONAL`. Eligible next Goals: none
